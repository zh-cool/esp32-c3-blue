...
typedef struct _led_control_LightConfig {
 ...
 仅 IC 类型灯带有效；PWM 类型忽略。 */
    pb_callback_t color_order;
    uint32_t led_count; /* 灯带上的 LED / IC 数量 */
} led_control_LightConfig;

/* 设备只读属性，固件编译时确定 */
typedef struct _led_control_DeviceInfo {
    pb_callback_t device_name; /* 蓝牙广播名 / 设备标识 */
    pb_callback_t fw_version; /* 固件版本，如 "2.1.0" */
    pb_callback_t hw_version; /* 硬件版本 */
    pb_callback_t manufacturer; /* 制造商 */
...
typedef struct _led_control_CustomScene {
    ...
    pb_callback_t name; /* 场景名称（最长32字节，UTF-8） */
    uint32_t segment_count; /* 分段数目 */
    pb_callback_t segments; /* 分段列表（最多 10 段） */
...
typedef struct _led_control_SetLightConfigResponse {
    ...
    pb_callback_t error_msg; /* 错误原因描述 */
...
typedef struct _led_control_EnvelopeResponse {
    ...
    pb_callback_t error_msg; /* 错误时的详细描述 */
...
#define led_control_LightConfig_init_default     {_led_control_DeviceType_MIN, {{NULL}, NULL}, 0}
#define led_control_DeviceInfo_init_default      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _led_control_DeviceType_MIN, 0, 0, 0, 0, 0, 0, 0}
...
#define led_control_CustomScene_init_default     {0, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0}
...
#define led_control_SetLightConfigResponse_init_default {_led_control_ErrorCode_MIN, {{NULL}, NULL}, 0}
#define led_control_SetCustomChannelOrderRequest_init_default {{{NULL}, NULL}}
#define led_control_SetCustomChannelOrderResponse_init_default {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
...
#define led_control_SetChannelModeResponse_init_default {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
...
#define led_control_SceneOperationResponse_init_default {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
#define led_control_ListScenesRequest_init_default {0}
#define led_control_ListScenesResponse_init_default {{{NULL}, NULL}}
#define led_control_SceneSummary_init_default    {0, {{NULL}, NULL}}
...
#define led_control_OTADataParams_init_default   {0, {{NULL}, NULL}}
#define led_control_OTARequest_init_default      {_led_control_OTARequest_Cmd_MIN, 0, {led_control_OTAStartParams_init_default}}
#define led_control_OTAResponse_init_default     {_led_control_ErrorCode_MIN, {{NULL}, NULL}, 0, 0, 0, 0}
...
#define led_control_EnvelopeResponse_init_default {0, _led_control_ErrorCode_MIN, {{NULL}, NULL}, 0, {led_control_GetDeviceInfoResponse_init_default}}
#define led_control_ColorRGB_init_zero           {0, 0, 0}
#define led_control_ColorTemperature_init_zero   {0}
#define led_control_LightConfig_init_zero        {_led_control_DeviceType_MIN, {{NULL}, NULL}, 0}
#define led_control_DeviceInfo_init_zero         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _led_control_DeviceType_MIN, 0, 0, 0, 0, 0, 0, 0}
...
#define led_control_CustomScene_init_zero        {0, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0}
...
#define led_control_SetLightConfigResponse_init_zero {_led_control_ErrorCode_MIN, {{NULL}, NULL}, 0}
#define led_control_SetCustomChannelOrderRequest_init_zero {{{NULL}, NULL}}
#define led_control_SetCustomChannelOrderResponse_init_zero {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
...
#define led_control_SetChannelModeResponse_init_zero {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
...
#define led_control_SceneOperationResponse_init_zero {_led_control_ErrorCode_MIN, {{NULL}, NULL}}
#define led_control_ListScenesRequest_init_zero  {0}
#define led_control_ListScenesResponse_init_zero {{{NULL}, NULL}}
#define led_control_SceneSummary_init_zero       {0, {{NULL}, NULL}}
...
#define led_control_OTADataParams_init_zero      {0, {{NULL}, NULL}}
#define led_control_OTARequest_init_zero         {_led_control_OTARequest_Cmd_MIN, 0, {led_control_OTAStartParams_init_zero}}
#define led_control_OTAResponse_init_zero        {_led_control_ErrorCode_MIN, {{NULL}, NULL}, 0, 0, 0, 0}
...
#define led_control_EnvelopeResponse_init_zero   {0, _led_control_ErrorCode_MIN, {{NULL}, NULL}, 0, {led_control_GetDeviceInfoResponse_init_zero}}
...
X(a, CALLBACK, REPEATED, UINT32,   color_order,       2) \
X(a, STATIC,   SINGULAR, UINT32,   led_count,         3)
#define led_control_LightConfig_CALLBACK pb_default_field_callback
...
#define led_control_DeviceInfo_CALLBACK pb_default_field_callback
...
#define led_control_CustomScene_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   error_msg,         2) \
X(a, STATIC,   SINGULAR, BOOL,     restart_required,   3)
#define led_control_SetLightConfigResponse_CALLBACK pb_default_field_callback
...
X(a, STATIC,   SINGULAR, UENUM,    error,             1) \
X(a, CALLBACK, SINGULAR, STRING,   error_msg,         2)
#define led_control_SetCustomChannelOrderResponse_CALLBACK pb_default_field_callback
...
X(a, STATIC,   SINGULAR, UENUM,    error,             1) \
X(a, CALLBACK, SINGULAR, STRING,   error_msg,         2)
#define led_control_SetChannelModeResponse_CALLBACK pb_default_field_callback
...
X(a, STATIC,   SINGULAR, UENUM,    error,             1) \
X(a, CALLBACK, SINGULAR, STRING,   error_msg,         2)
#define led_control_SceneOperationResponse_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, REPEATED, MESSAGE,  scenes,            1)
#define led_control_ListScenesResponse_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   name,              2)
#define led_control_SceneSummary_CALLBACK pb_default_field_callback
...
#define led_control_OTADataParams_CALLBACK pb_default_field_callback
...
#define led_control_OTAResponse_CALLBACK pb_default_field_callback
...
#define led_control_EnvelopeResponse_CALLBACK pb_default_field_callback
...
/* led_control_LightConfig_size depends on runtime parameters */
/* led_control_DeviceInfo_size depends on runtime parameters */
/* led_control_CustomScene_size depends on runtime parameters */
/* led_control_DeviceStatus_size depends on runtime parameters */
/* led_control_GetDeviceInfoResponse_size depends on runtime parameters */
/* led_control_SetLightConfigRequest_size depends on runtime parameters */
/* led_control_SetLightConfigResponse_size depends on runtime parameters */
/* led_control_SetCustomChannelOrderRequest_size depends on runtime parameters */
/* led_control_SetCustomChannelOrderResponse_size depends on runtime parameters */
/* led_control_SetChannelModeResponse_size depends on runtime parameters */
/* led_control_SceneOperationRequest_size depends on runtime parameters */
/* led_control_SceneOperationResponse_size depends on runtime parameters */
/* led_control_ListScenesResponse_size depends on runtime parameters */
/* led_control_SceneSummary_size depends on runtime parameters */
/* led_control_StateNotification_size depends on runtime parameters */
/* led_control_OTADataParams_size depends on runtime parameters */
/* led_control_OTARequest_size depends on runtime parameters */
/* led_control_OTAResponse_size depends on runtime parameters */
/* led_control_Envelope_size depends on runtime parameters */
/* led_control_EnvelopeResponse_size depends on runtime parameters */
#define LED_CONTROL_LED_CONTROL_PB_H_MAX_SIZE    led_control_StaticState_size
